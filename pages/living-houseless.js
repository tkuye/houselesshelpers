...
const LivingHouseless = () => {
    ...
    return (
        <div>
            ...
            <p className={styles.description}>Living Houseless is a series that aims to spread awareness about the stories, lives and struggles faced by the vulnerable community. Please contact me at (780) 914-5692 if you have any questions.</p>
